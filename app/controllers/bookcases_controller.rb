class BookcasesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @bookcase.update(bookcase_params)
        format.html { redirect_to @bookcase, notice: "Bookcase was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to bookcases_path, notice: "Bookcase was successfully destroyed.", status: :see_other }
